...
%macro import_fps_assortment(fps_current_folder=, fps_deleted_folder=);
  ...
  data FPS_Assortment_current(drop=_:);
      set FPS_Assortment_current_raw(keep= Material_ID  Material_basic_description__EN_  Material_sales_text__EN_  Material_division  PF_for_sales_text  Sales_unit  Alt__Unit  Sub_unit  DM_Process_stage  FND_Variety_Nb  PMD_Variety_Nb  FPS_variety_name  Product_line_Reporting  Forecasting_group  Species_name  FPS_series_description  Curr_Var_PLC_FPS  Curr_Mat_PLC replaced_by Future_Material_PLC Material_Future_PLC_valid_from
